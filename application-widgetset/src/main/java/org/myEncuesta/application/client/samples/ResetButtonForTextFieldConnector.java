package org.myEncuesta.application.client.samples;
...
import org.myEncuesta.application.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@org.myEncuesta.application.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
