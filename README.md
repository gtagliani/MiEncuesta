...
- application-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- application-ui: main application module, development time
- application-production: module that produces a production mode WAR for deployment
